export function ContactForm(){
    ...
    .contact-form {
      ...
      .contact-form [required]:valid {
        /* para cuando el texto sea valido */
    ...
    <input
      ...
      title="El nombre solo acepta lestras y espacios en blanco"
    ...
    function validationsForm() {
        ...
        d.addEventListener("submit", (e) => {
          ...
          fetch("https://formsubmit.co/ajax/diego.gup.75@gmail.com",{
              method: "POST",
              body:new FormData(e.target)//el e.target es el formulario//FormDATA parsea los elementos del formulario
          })
          ...
          .catch(err => {
              console.log(err);
              let message = err.statusText || "Ourrio un error al enviar el formulario";
